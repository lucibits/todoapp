...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show completed entries', function () {
			...
			subject.setView('');
			//if when view.render executes the parameter was called
			expect(view.render).toHaveBeenCalledWith('showEntries', [todo]);
		});
	});
	...
	it('should check the toggle all button, if all todos are completed', function () {
		setUpModel([{id: 1, title: 'my todo', completed: true}]);
	...
	describe('toggle all', function () {
		...
		it('should update the view', function () {
			...
			view.trigger('toggleAll', true);
			expect(view.render).toHaveBeenCalledWith('elementComplete', {id: 123456, completed: true});
		});
	});
